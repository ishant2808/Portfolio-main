          ...
          <div className="contact--info">
            <div className="contact--card">
              ...
              <span className="contact--card-data">
                pranjal.ishant@gmail.com
              </span>

              <a href="mailto:pranjal.ishant.com" className="contact--button">
                Write me
            ...
            <div className="contact--card">
              ...
              <span className="contact--card-data">+91-8382882213</span>
            </div>

            <div className="contact--card">
              <i className="bx bx-home contact--card-icon"></i>
              <h3 className="contact--card-title">Address</h3>
              <span className="contact--card-data">Greater Noida, Uttar Pradesh</span>
            </div>
          </div>
        </div>
